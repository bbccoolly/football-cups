...
@pytest.mark.parametrize(
    ...
    [
        ...
        base_record(
            ...
            source_sha256="scope",
            inventory_batch_record_id="sporttery-batch",
            scope="90-minutes-including-stoppage",
            scope_text="全场比分（90分钟）包含伤停补时阶段",
            status="accepted",
        ),
        base_record(
        ...
        base_record(
            ...
            sporttery_match_id="2040541",
            observed_at="2026-07-16T01:00:00Z",
            inventory_batch_record_id="sporttery-batch",
            match_number="周日104",
            mapping_status="accepted",
            official_kickoff_at="2026-07-16T01:00:00Z",
            official_home_name="Home",
            official_away_name="Away",
        ),
        base_record(
            ...
            away_goals=0,
            status_text="已完成",
            result_status_text="已开奖",
            is_cancel=False,
            scope="90-minutes-including-stoppage",
            inventory_batch_record_id="sporttery-batch",
            scope_evidence_record_id="scope",
            fixture_link_record_id="link",
            inventory_sha256="inventory",
            head_sha256="head",
            fixed_bonus_sha256="fixed",
            source_urls=[],
            raw_summary={},
        ),
        base_record(
