...
完成注销 Windows 用户至少 10 分钟的无人值守验证：重新登录后确认注销期间采集至少两轮、数据库至少一轮且 `health=ok`。Windows 重启恢复已经通过，不再重复执行。期间继续 7 天技术验证、从 2026-07-17 10:44:44 Asia/Shanghai 开始的 30 天赛果窗口和每日 3 场人工核验。阿里云 ECS 保持所有 timer 禁用。
