...
- 当前只有 4 场具有唯一有效赛果；V2模型合格批次虽有93个，但尚不能替代“同切点模型严格快照+唯一赛果”的500场门禁。
...
连续观察盘口 V2 上线后的首个24小时：在 2026-07-18 17:56:56 Asia/Shanghai 后生成精确窗口报告，核对实时乱码、盘口转换、三家公司门槛、模型资格原因和 V1/V2 重复均为预期。期间继续每日3场人工核验，并完成注销 Windows 用户至少10分钟的无人值守验证。阿里云 ECS 保持所有 timer 禁用。
