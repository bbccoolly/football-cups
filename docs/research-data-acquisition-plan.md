...
本文档固化 2025 年至当前时间的免费历史研究数据获取步骤和已有结果。自 D-011 起，500 前瞻采集成为当前主路线；本路线保留用于字段、覆盖和历史回抓风险研究，不再阻塞当前阶段，也不继续扩大 CentroQuote 批量回填。
...
- 阶段门禁：历史研究数据不能获得严格回测资格；正式数据库、模型和 Web 产品仍等待 500 的 7 天及 30 天验收。
